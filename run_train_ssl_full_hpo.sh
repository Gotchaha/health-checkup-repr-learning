#!/bin/bash
#$ -N ssl_training_full_hpo          # Job name
...
echo "=============================================="
echo "SSL Training full_hpo (v1) Job Started"
echo "=============================================="
echo "Job ID: $JOB_ID"
...
echo "Starting SSL training full_hpo..."
echo "Config: config/experiments/ssl_pretraining_v1_full_hpo.yaml"
echo "=============================================="

# Run training
python scripts/train_ssl.py --config config/experiments/ssl_pretraining_v1_full_hpo.yaml

# Capture exit status
EXIT_STATUS=$?

echo "=============================================="
echo "SSL Training full_hpo Job Completed"

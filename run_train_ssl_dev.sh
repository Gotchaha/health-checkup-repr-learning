...
echo "=============================================="
echo "SSL Training dev (v1) Job Started"
echo "=============================================="
echo "Note: Test default multi-worker settings"
echo "Job ID: $JOB_ID"
...
echo "Starting SSL training dev..."
echo "Config: config/experiments/ssl_pretraining_v1_dev.yaml"
echo "=============================================="

# Run training
python scripts/train_ssl.py --config config/experiments/ssl_pretraining_v1_dev.yaml

# Capture exit status
EXIT_STATUS=$?

echo "=============================================="
echo "SSL Training dev Job Completed"

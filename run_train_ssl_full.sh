...
echo "=============================================="
echo "SSL Training full (v1) Job Started"
echo "=============================================="
echo "Job ID: $JOB_ID"
...
echo "Starting SSL training full..."
echo "Config: config/experiments/ssl_pretraining_v1_full.yaml"
echo "=============================================="
...
echo "=============================================="
echo "SSL Training full Job Completed"

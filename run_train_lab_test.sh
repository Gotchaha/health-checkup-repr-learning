#!/bin/bash
#$ -N lab_test_training         # Job name
#$ -l a100=1,s_vmem=512G        # Resources: 1 A100 GPU, mem usage soft limit: 768G total
...
echo "=============================================="
echo "Lab Test Downstream Training (v1) Job Started"
echo "=============================================="
echo "Job ID: $JOB_ID"
...
echo "Starting downstream lab test training..."
echo "Config: config/downstream/lab_test_task_config_v1.yaml"
echo "=============================================="
...
echo "=============================================="
echo "Lab Test Downstream Training (v1) Job Completed"
